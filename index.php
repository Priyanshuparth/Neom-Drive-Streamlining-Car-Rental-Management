...
<head>
  ...
  <title>Neom Drive | Experience the future</title>
    ...
    <div class="swiper-wrapper">
      ...
      <div class="swiper-slide slide">
        <div class="content">
          ...
          <a href="carlisting.php" class="btn">see menus</a>
        </div>
        <div class="image">
      ...
      <div class="swiper-slide slide">
        <div class="content">
          <span>Book Now</span>
          <h3>SUV</h3>
          <a href="carlisting.php" class="btn">see more</a>
        </div>
        <div class="image">
          <img src="./image/suv-img.jpg" alt="">
        </div>
      </div>
      ...
      <div class="swiper-slide slide">
        ...
        <div class="image">
          <img src="./image/sedan-img.jpg" alt="">
        </div>
      </div>
      ...
      <div class="swiper-slide slide">
        ...
        <div class="image">
          <img src="./image/sports-img.jpg" alt="">
        </div>
      </div>
