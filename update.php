...
<body>
<?php
// fetch database and update values 
$p=$_POST["PRICE"];
$i=$_POST["pid"];
...
mysqli_query($con, "UPDATE payment SET payment='$p' where pid='$i'") or die(mysqli_connect_error());
...
<header class="header">
 ...
 <p style="text-align:center">
 <a  href="carlisting.php">Check Updated Listings!</a>
 </p>
</body>
</html>